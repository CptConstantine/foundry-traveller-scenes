...
The project generates Traveller scenes from TravellerMap data. The current MVP searches for a sector, creates a new Foundry scene using the TravellerMap poster as the background image, and aligns a Foundry hex grid to that poster.

## Relevant APIs

Use only Foundry VTT v14 API.

- TravellerMap API docs — search, poster rendering, coordinates, metadata, and sector data: https://travellermap.com/doc/api
