...
Foundry VTT v14 module that creates Traveller sector and subsector scenes from TravellerMap poster data, then overlays a correctly aligned Traveller hex grid.

## MVP features

- Search TravellerMap for a sector or subsector
